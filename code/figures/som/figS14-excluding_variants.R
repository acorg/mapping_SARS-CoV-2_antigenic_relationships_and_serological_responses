...
ggsave("figures/som/figS14-excluding_variants.pdf", gp, width = 8.5*1.3, height = 12.5*1.3, units = "in")
ggsave("figures/som/figS14-excluding_variants.png", gp, width = 8.5*1.3, height = 12.5*1.3, units = "in")
