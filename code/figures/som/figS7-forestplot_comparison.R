...
comparison_folddrops <- readxl::read_excel("data/comparison_to_other_studies.xlsx", range = "B3:J43")
...
# folddrops$sr_group <- fct_recode(
#   folddrops$sr_group,
#   "4 weeks post 3x mRNA-1273" = "3x mRNA-1273 BD29",
#   "4 weeks post 2x mRNA-1273" = "2x mRNA-1273"
# )
...
ggsave(
  plot = gp,
  filename = "figures/som/figS7-forestplot_comparison.pdf",
  width = 10,
  height = 8.5,
  units = "in"
)
...
ggsave(
  plot = gp,
  filename = "figures/som/figS7-forestplot_comparison.png",
  width = 10,
  height = 8.5,
  units = "in"
)
