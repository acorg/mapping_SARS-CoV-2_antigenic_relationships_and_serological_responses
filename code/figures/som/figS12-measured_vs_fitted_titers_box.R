...
ggsave('figures/som/figS12-measured_vs_fitted_titers_box.png', width = 11, height = 10)
ggsave('figures/som/figS12-measured_vs_fitted_titers_box.pdf', width = 11, height = 10)
