...
ggsave("figures/som/figS23-BA45_scatters.pdf", plot = scatterplotsBA45, width = 10.5, height = 2.8, units = "in")
ggsave("figures/som/figS23-BA45_scatters.png", plot = scatterplotsBA45, width = 10.5, height = 2.8, units = "in")
...
ggsave("figures/som/figS25-D614G_mutant_scatters.pdf", plot = mutants_d614g, width = 4.6, height = 8.5, units = "in")
ggsave("figures/som/figS25-D614G_mutant_scatters.png", plot = mutants_d614g, width = 4.6, height = 8.5, units = "in")
...
ggsave("figures/som/figS26-417_mutant_scatters.pdf", plot = mutants417, width = 4.6, height = 10, units = "in")
ggsave("figures/som/figS26-417_mutant_scatters.png", plot = mutants417, width = 4.6, height = 10, units = "in")

# Effect of 501 mutation plots
mutants501 <- scatterplot_ags("D614G", "D614G+N501Y", c("2x mRNA-1273", "D614G", "B.1.1.7", "P.1", "B.1.351"))
ggsave("figures/som/figS27-501_mutant_scatters.pdf", plot = mutants501, width = 9.5, height = 2.8, units = "in")
ggsave("figures/som/figS27-501_mutant_scatters.png", plot = mutants501, width = 9.5, height = 2.8, units = "in")
...
ggsave("figures/som/figS28-BA1_A484K_scatter.pdf", plot = mutantsBA1, width = 8.5, height = 2.8, units = "in")
ggsave("figures/som/figS28-BA1_A484K_scatter.png", plot = mutantsBA1, width = 8.5, height = 2.8, units = "in")
