...
# Save the plot
ggsave("figures/som/figS26-ablandscapes_fitted_vs_measured.pdf", gp, width = 14, height = 12, units = "in")
ggsave("figures/som/figS26-ablandscapes_fitted_vs_measured.png", gp, width = 14, height = 12, units = "in")
