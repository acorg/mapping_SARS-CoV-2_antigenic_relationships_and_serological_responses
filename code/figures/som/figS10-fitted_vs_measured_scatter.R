...
ggsave("figures/som/figS10-fitted_vs_measured_scatter.png", width=5.3, height=5)
ggsave("figures/som/figS10-fitted_vs_measured_scatter.pdf", width=5.3, height=5)
