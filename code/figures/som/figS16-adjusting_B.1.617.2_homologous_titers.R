...
ggsave(plot = gp, filename = "figures/som/figS16-adjusting_B.1.617.2_homologous.pdf", width = 20, height = 9, units = "in")
ggsave(plot = gp, filename = "figures/som/figS16-adjusting_B.1.617.2_homologous.png", width = 20, height = 9, units = "in")
