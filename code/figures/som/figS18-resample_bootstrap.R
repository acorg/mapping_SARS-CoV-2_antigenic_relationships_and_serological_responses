...
ggsave(plot = gp, filename = "figures/som/figS18-resample_bootstrap_map.pdf", width = 12, height = 4, units = "in")
ggsave(plot = gp, filename = "figures/som/figS18-resample_bootstrap_map.png", width = 12, height = 4, units = "in")
