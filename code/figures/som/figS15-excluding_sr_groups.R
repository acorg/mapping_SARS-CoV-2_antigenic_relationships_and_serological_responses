...
ggsave("figures/som/figS15-excluding_sr_groups.pdf", gp, width = 12, height = 12, units = "in")
ggsave("figures/som/figS15-excluding_sr_groups.png", gp, width = 12, height = 12, units = "in")
