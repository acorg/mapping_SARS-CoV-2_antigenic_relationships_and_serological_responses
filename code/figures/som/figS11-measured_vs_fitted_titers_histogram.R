...
ggsave("figures/som/figS11-measured_vs_fitted_titers_histogram.png", width = 7, height = 4)
ggsave("figures/som/figS11-measured_vs_fitted_titers_histogram.pdf", width = 7, height = 4)
