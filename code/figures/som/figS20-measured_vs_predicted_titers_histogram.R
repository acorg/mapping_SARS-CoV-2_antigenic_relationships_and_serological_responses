...
ggsave("figures/som/figS20-measured_vs_predicted_titers_histogram.png", width=5, height=4)
ggsave("figures/som/figS20-measured_vs_predicted_titers_histogram.pdf", width=5, height=4)
