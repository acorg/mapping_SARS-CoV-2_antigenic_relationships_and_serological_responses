...
ggsave(
  filename = "figures/som/figS21-error_and_triangulation_maps.png",
  plot = gp,
  width = 12,
  height = 5.8,
  units = "in"
...
ggsave(
  filename = "figures/som/figS21-error_and_triangulation_maps.pdf",
  plot = gp,
  width = 12,
  height = 5.8,
  units = "in"
...
saveRDS(
  ...
  file = "figures/som/figS21b-triangulation_blobs.rds"
)
