...
```{r}
Racmacs::view(
  readRDS("../../data/generated_data/map_bootstrap_bayesian_ags_srs.rds")
)
```
...
```{r}
Racmacs::view(
  readRDS("../../data/generated_data/map_bootstrap_bayesian_srs.rds")
)
```
...
```{r}
Racmacs::view(
  readRDS("../../data/generated_data/map_bootstrap_bayesian_ags.rds")
)
```
