...
# Save the results
saveRDS(bootstrap_map_ags, "data/generated_data/map_bootstrap_resample_ags.rds")
saveRDS(bootstrap_map_srs, "data/generated_data/map_bootstrap_resample_srs.rds")
saveRDS(bootstrap_map_ags_srs, "data/generated_data/map_bootstrap_resample_ags_srs.rds")
