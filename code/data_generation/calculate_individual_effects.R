...
saveRDS(individual_effects, file = "data/generated_data/individual_effects.rds")
saveRDS(ag_means_individual_effects, file = "data/generated_data/ag_gmt_individual_effects.rds")
